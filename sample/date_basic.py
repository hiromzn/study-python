...
dt = dt1;
print (("type: %s") % type(ds1))
print (("type: %s") % type(dt1))
print (("type: %s") % type(dt))
print ( ("date 1: %s") %  dt.date() )
print (("type: %s") % type(dt.date()))
print ( ("  week number: W : %s") %  dt.strftime("%W"))
print ( ("  my date : %s") %  dt.strftime("%Y-%m-%d"))
print (("type: %s") % type(dt.strftime("%Y-%m-%d")))
